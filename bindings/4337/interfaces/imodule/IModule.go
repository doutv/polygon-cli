...
func (_IModule *IModuleCaller) IsModuleType(opts *bind.CallOpts, moduleTypeId *big.Int) (bool, error) {
	var out []interface{}
	err := _IModule.contract.Call(opts, &out, "isModuleType", moduleTypeId)
...
//
// Solidity: function isModuleType(uint256 moduleTypeId) view returns(bool)
func (_IModule *IModuleSession) IsModuleType(moduleTypeId *big.Int) (bool, error) {
	return _IModule.Contract.IsModuleType(&_IModule.CallOpts, moduleTypeId)
}

// IsModuleType is a free data retrieval call binding the contract method 0xecd05961.
//
// Solidity: function isModuleType(uint256 moduleTypeId) view returns(bool)
func (_IModule *IModuleCallerSession) IsModuleType(moduleTypeId *big.Int) (bool, error) {
	return _IModule.Contract.IsModuleType(&_IModule.CallOpts, moduleTypeId)
}
