...
func (_IOracle *IOracleCaller) Decimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _IOracle.contract.Call(opts, &out, "decimals")
...
//
// Solidity: function decimals() view returns(uint8)
func (_IOracle *IOracleSession) Decimals() (uint8, error) {
	return _IOracle.Contract.Decimals(&_IOracle.CallOpts)
}

// Decimals is a free data retrieval call binding the contract method 0x313ce567.
//
// Solidity: function decimals() view returns(uint8)
func (_IOracle *IOracleCallerSession) Decimals() (uint8, error) {
	return _IOracle.Contract.Decimals(&_IOracle.CallOpts)
}
...
func (_IOracle *IOracleCaller) LatestRoundData(opts *bind.CallOpts) (struct {
	RoundId         *big.Int
	Answer          *big.Int
	StartedAt       *big.Int
	UpdatedAt       *big.Int
	...
	var out []interface{}
	err := _IOracle.contract.Call(opts, &out, "latestRoundData")
...
//
// Solidity: function latestRoundData() view returns(uint80 roundId, int256 answer, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound)
func (_IOracle *IOracleSession) LatestRoundData() (struct {
	RoundId         *big.Int
	Answer          *big.Int
	StartedAt       *big.Int
	UpdatedAt       *big.Int
	...
	return _IOracle.Contract.LatestRoundData(&_IOracle.CallOpts)
}

// LatestRoundData is a free data retrieval call binding the contract method 0xfeaf968c.
//
// Solidity: function latestRoundData() view returns(uint80 roundId, int256 answer, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound)
func (_IOracle *IOracleCallerSession) LatestRoundData() (struct {
	RoundId         *big.Int
	Answer          *big.Int
	StartedAt       *big.Int
	UpdatedAt       *big.Int
